...
// -----------------------------------------------------------------------
#define FnEnv(...) TYPE_NAME(CAT(FnEnv, __LINE__), __VA_ARGS__)
#define typedef_FnEnv(...) typedef_FnEnv0(__VA_ARGS__)

#define typedef_FnEnv0(...)                                              \
  CAT(typedef_FnEnv, VARIADIC_SIZE(__VA_ARGS__))(__VA_ARGS__)

#define typedef_FnEnv1(T1)                                               \
  typedef struct {                                                       \
    T1 e1;                                                               \
  } FnEnv(T1)

#define typedef_FnEnv2(T1, T2)                                           \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
  } FnEnv(T1, T2)

#define typedef_FnEnv3(T1, T2, T3)                                       \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
    T3 e3;                                                               \
...
#define typedef_FnEnv4(T1, T2, T3, T4)                                   \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
    T3 e3;                                                               \
...
#define typedef_FnEnv5(T1, T2, T3, T4, T5)                               \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
    T3 e3;                                                               \
    T4 e4;                                                               \
    T5 e5;                                                               \
  } FnEnv(T1, T2, T3, T4, T5)

#define typedef_FnEnv6(T1, T2, T3, T4, T5, T6)                           \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
    T3 e3;                                                               \
    ...
    T5 e5;                                                               \
    T6 e6;                                                               \
  } FnEnv(T1, T2, T3, T4, T5, T6)

#define typedef_FnEnv7(T1, T2, T3, T4, T5, T6, T7)                       \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
    T3 e3;                                                               \
    ...
    T6 e6;                                                               \
    T7 e7;                                                               \
  } FnEnv(T1, T2, T3, T4, T5, T6, T7)

#define typedef_FnEnv8(T1, T2, T3, T4, T5, T6, T7, T8)                   \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
    T3 e3;                                                               \
    ...
    T7 e7;                                                               \
    T8 e8;                                                               \
  } FnEnv(T1, T2, T3, T4, T5, T6, T7, T8)

#define typedef_FnEnv9(T1, T2, T3, T4, T5, T6, T7, T8, T9)               \
  typedef struct {                                                       \
    T1 e1;                                                               \
    T2 e2;                                                               \
    T3 e3;                                                               \
    ...
    T8 e8;                                                               \
    T9 e9;                                                               \
  } FnEnv(T1, T2, T3, T4, T5, T6, T7, T8, T9)
...
#define fn1(name, T1, R)                                                 \
  ...
  static R FUNC_NAME(name, apply0)(FnEnv(T1) * args);                    \
  /* ---- */                                                             \
  static Fn(T1, R) name(void) {                                          \
    return (Fn(T1, R)){                                                  \
        .args = malloc(sizeof(FnEnv(T1))),                               \
...
#define fn2(name, T2, T1, R)                                             \
  ...
  static R FUNC_NAME(name, apply1)(void* args, T1 x);                    \
  static R FUNC_NAME(name, apply0)(FnEnv(T2, T1) * args);                \
  /* ---- */                                                             \
  static Fn(T2, T1, R) name(void) {                                      \
    return (Fn(T2, T1, R)){                                              \
        .args = malloc(sizeof(FnEnv(T2, T1))),                           \
...
#define fn4(name, T4, T3, T2, T1, R)                                     \
  ...
  static Fn(T1, R) FUNC_NAME(name, apply2)(void* args, T2 x);            \
  static R FUNC_NAME(name, apply1)(void* args, T1 x);                    \
  static R FUNC_NAME(name, apply0)(FnEnv(T4, T3, T2, T1) * args);        \
  /* ---- */                                                             \
  static Fn(T4, T3, T2, T1, R) name(void) {                              \
    return (Fn(T4, T3, T2, T1, R)){                                      \
        .args = malloc(sizeof(FnEnv(T4, T3, T2, T1))),                   \
        .apply = FUNC_NAME(name, apply4),                                \
    };                                                                   \
  }                                                                      \
  static Fn(T3, T2, T1, R) FUNC_NAME(name, apply4)(void* args, T4 x) {   \
    FnEnv(T4, T3, T2, T1)* t = args;                                     \
    t->e1 = x;                                                           \
    return (Fn(T3, T2, T1, R)){                                          \
        .args = args,                                                    \
        .apply = FUNC_NAME(name, apply3),                                \
...
#define fn5(name, T5, T4, T3, T2, T1, R)                                 \
  ...
  static Fn(T1, R) FUNC_NAME(name, apply2)(void* args, T2 x);            \
  static R FUNC_NAME(name, apply1)(void* args, T1 x);                    \
  static R FUNC_NAME(name, apply0)(FnEnv(T5, T4, T3, T2, T1) * args);    \
  /* ---- */                                                             \
  static Fn(T5, T4, T3, T2, T1, R) name(void) {                          \
    return (Fn(T5, T4, T3, T2, T1, R)){                                  \
        .args = malloc(sizeof(FnEnv(T5, T4, T3, T2, T1))),               \
        .apply = FUNC_NAME(name, apply5),                                \
    };                                                                   \
  }                                                                      \
  static Fn(T4, T3, T2, T1, R)                                           \
      FUNC_NAME(name, apply5)(void* args, T5 x) {                        \
    FnEnv(T5, T4, T3, T2, T1)* t = args;                                 \
    t->e1 = x;                                                           \
    return (Fn(T4, T3, T2, T1, R)){                                      \
        .args = args,                                                    \
        .apply = FUNC_NAME(name, apply4),                                \
...
#define fn6(name, T6, T5, T4, T3, T2, T1, R)                             \
  C_API_BEGIN                                                            \
  /* ---- */                                                             \
  typedef_FnEnv(T6, T5, T4, T3, T2, T1);                                 \
  /* ---- */                                                             \
  ...
  static R FUNC_NAME(name,                                               \
                     apply0)(FnEnv(T6, T5, T4, T3, T2, T1) * args);      \
  /* ---- */                                                             \
  static Fn(T6, T5, T4, T3, T2, T1, R) name(void) {                      \
    return (Fn(T6, T5, T4, T3, T2, T1, R)){                              \
        .args = malloc(sizeof(FnEnv(T6, T5, T4, T3, T2, T1))),           \
        .apply = FUNC_NAME(name, apply6),                                \
    };                                                                   \
  }                                                                      \
  static Fn(T5, T4, T3, T2, T1, R)                                       \
      FUNC_NAME(name, apply6)(void* args, T6 x) {                        \
    FnEnv(T6, T5, T4, T3, T2, T1)* t = args;                             \
    t->e1 = x;                                                           \
    return (Fn(T5, T4, T3, T2, T1, R)){                                  \
        .args = args,                                                    \
        .apply = FUNC_NAME(name, apply5),                                \
  ...
  C_API_END                                                              \
  /* ---- */                                                             \
  static R FUNC_NAME(name, apply0)(FnEnv(T6, T5, T4, T3, T2, T1) * args)

// -----------------------------------------------------------------------
#define fn7(name, T7, T6, T5, T4, T3, T2, T1, R)                         \
  C_API_BEGIN                                                            \
  /* ---- */                                                             \
  typedef_FnEnv(T7, T6, T5, T4, T3, T2, T1);                             \
  /* ---- */                                                             \
  ...
  static R FUNC_NAME(name, apply1)(void* args, T1 x);                    \
  static R FUNC_NAME(name,                                               \
                     apply0)(FnEnv(T7, T6, T5, T4, T3, T2, T1) * args);  \
  /* ---- */                                                             \
  static Fn(T7, T6, T5, T4, T3, T2, T1, R) name(void) {                  \
    return (Fn(T7, T6, T5, T4, T3, T2, T1, R)){                          \
        .args = malloc(sizeof(FnEnv(T7, T6, T5, T4, T3, T2, T1))),       \
        .apply = FUNC_NAME(name, apply7),                                \
    };                                                                   \
  }                                                                      \
  static Fn(T6, T5, T4, T3, T2, T1, R)                                   \
      FUNC_NAME(name, apply7)(void* args, T7 x) {                        \
    FnEnv(T7, T6, T5, T4, T3, T2, T1)* t = args;                         \
    t->e1 = x;                                                           \
    return (Fn(T6, T5, T4, T3, T2, T1, R)){                              \
        .args = args,                                                    \
        .apply = FUNC_NAME(name, apply6),                                \
...
#define fn8(name, T8, T7, T6, T5, T4, T3, T2, T1, R)                     \
  C_API_BEGIN                                                            \
  /* ---- */                                                             \
  typedef_FnEnv(T8, T7, T6, T5, T4, T3, T2, T1);                         \
  /* ---- */                                                             \
  ...
  static R FUNC_NAME(name, apply0)(                                      \
      FnEnv(T8, T7, T6, T5, T4, T3, T2, T1) * args);                     \
  /* ---- */                                                             \
  static Fn(T8, T7, T6, T5, T4, T3, T2, T1, R) name(void) {              \
    return (Fn(T8, T7, T6, T5, T4, T3, T2, T1, R)){                      \
        .args = malloc(sizeof(FnEnv(T8, T7, T6, T5, T4, T3, T2, T1))),   \
        .apply = FUNC_NAME(name, apply8),                                \
    };                                                                   \
  }                                                                      \
  static Fn(T7, T6, T5, T4, T3, T2, T1, R)                               \
      FUNC_NAME(name, apply8)(void* args, T8 x) {                        \
    FnEnv(T8, T7, T6, T5, T4, T3, T2, T1)* t = args;                     \
    t->e1 = x;                                                           \
    return (Fn(T7, T6, T5, T4, T3, T2, T1, R)){                          \
        .args = args,                                                    \
        .apply = FUNC_NAME(name, apply7),                                \
...
#define fn9(name, T9, T8, T7, T6, T5, T4, T3, T2, T1, R)                 \
  C_API_BEGIN                                                            \
  /* ---- */                                                             \
  typedef_FnEnv(T9, T8, T7, T6, T5, T4, T3, T2, T1);                     \
  /* ---- */                                                             \
  ...
  static R FUNC_NAME(name, apply1)(void* args, T1 x);                    \
  static R FUNC_NAME(name, apply0)(                                      \
      FnEnv(T9, T8, T7, T6, T5, T4, T3, T2, T1) * args);                 \
  /* ---- */                                                             \
  static Fn(T9, T8, T7, T6, T5, T4, T3, T2, T1, R) name(void) {          \
    return (Fn(T9, T8, T7, T6, T5, T4, T3, T2, T1, R)){                  \
        .args =                                                          \
            malloc(sizeof(FnEnv(T9, T8, T7, T6, T5, T4, T3, T2, T1))),   \
        .apply = FUNC_NAME(name, apply9),                                \
    };                                                                   \
  }                                                                      \
  static Fn(T8, T7, T6, T5, T4, T3, T2, T1, R)                           \
      FUNC_NAME(name, apply9)(void* args, T9 x) {                        \
    FnEnv(T9, T8, T7, T6, T5, T4, T3, T2, T1)* t = args;                 \
    t->e1 = x;                                                           \
    return (Fn(T8, T7, T6, T5, T4, T3, T2, T1, R)){                      \
        .args = args,                                                    \
        .apply = FUNC_NAME(name, apply8),                                \
